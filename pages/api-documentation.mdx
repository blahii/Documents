...
### Список банков
**URL**: `https://crypto-cash.world/merchant/api/v1/banks/list/`
...
### Покупка фиатных валют
**URL**: `https://crypto-cash.world/merchant/api/v1/balance/actions/buy/fiat/`
...
- **`iban`** (опционально): IBAN
- **`fullName`** (опционально): ФИО получателя
