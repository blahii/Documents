...
Первая попытка: задержка в 300 секунд (5 минут)
Вторая попытка: задержка в 600 секунд (10 минут)
Ошибка: задача удалена из очереди, логированна

---

### Widthdrawal - примеры ответов
